...
static const char col_gray1[]       = "#0B0D17";
static const char col_gray2[]       = "#0B0D17";
static const char col_gray3[]       = "#c5d1eb";
static const char col_gray4[]       = "#eeeeee";
static const char col_cyan[]        = "#198388";
...
/* commands */
static const char dmenuhp[] = "librewolf,whatsapp-nativefier,telegram-desktop,alacritty,pcmanfm,qbittorrent";
static const char *dmenucmd[] = { "dmenu_run", "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-hp", dmenuhp, NULL };
static const char *termcmd[] = { TERM, NULL };
static const char *upvol[] = { "/usr/bin/pactl", "set-sink-volume", "0", "+1%", NULL };	/* for pipewire-pulse & pulse */
